  ...
  return (
    <main id="top" className="overflow-x-clip bg-[#fbfbf8] text-stone-950">
      ...
      <section className="hero-section relative overflow-hidden pb-20 pt-16 sm:pb-28 sm:pt-20 lg:pb-32 lg:pt-28">
        <div className="absolute inset-x-0 top-0 -z-0 h-[680px] bg-[radial-gradient(ellipse_at_top,rgba(167,243,208,0.44),transparent_63%)]" />
        <div className="absolute left-[10%] top-20 -z-0 h-72 w-72 rounded-full bg-emerald-100/40 blur-3xl" />
        <div className="absolute right-[8%] top-36 -z-0 h-80 w-80 rounded-full bg-stone-200/55 blur-3xl" />
        <Container className="relative z-10">
          <div className="mx-auto max-w-[980px] text-center">
            <Reveal delay={0.02} y={12}><p className="inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-emerald-800">TINDIO for modern business</p></Reveal>
            <Reveal delay={0.08} y={18}><h1 className="hero-headline mt-6 text-balance text-[3.1rem] font-extrabold leading-[0.96] tracking-[-0.07em] sm:text-7xl lg:text-[5.6rem] xl:text-[6.35rem]">Sell simple. Grow smarter.</h1></Reveal>
            <Reveal delay={0.14} y={16}><p className="mx-auto mt-7 max-w-[630px] text-pretty text-lg leading-7 text-stone-600 sm:text-xl sm:leading-8">Run sales, inventory, employees and every store from one place.</p></Reveal>
            <Reveal delay={0.2} y={14}><div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <Button href={publicCtaDestinations.getStarted} size="lg">Get Started <ArrowRightIcon className="h-4 w-4" /></Button>
              <Button href={publicRoutes.interactiveDemo} variant="secondary" size="lg">Try the POS demo</Button>
            </div></Reveal>
          </div>

          <div id="product" className="hero-product-composition relative mx-auto mt-14 max-w-[1320px] sm:mt-16 lg:mt-20 xl:max-w-[1380px]">
            <ProductReveal delay={0.2}><AppFrame
            ...
            /></ProductReveal>
            <ProductReveal delay={0.32} className="hero-pos-overlay relative z-20 mx-auto mt-4 w-[82%] max-w-[420px] sm:absolute sm:-bottom-16 sm:right-0 sm:mt-0 sm:w-[45%] sm:max-w-[440px] lg:-bottom-20 lg:-right-3">
              <AppFrame
                title="TINDIO POS"
      ...
      <section id="reports" className="bg-white py-20 sm:py-28 lg:py-32">
        <Container>
          <div className="grid items-center gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:gap-16 xl:gap-24">
            <div className="max-w-[500px]">
      ...
      <section id="loyalty" className="bg-[#f5f6f2] py-20 sm:py-28 lg:py-32">
        <Container>
          <div className="grid items-center gap-12 lg:grid-cols-[1.22fr_0.78fr] lg:gap-16 xl:gap-24">
            <div className="order-2 mx-auto w-full max-w-[760px] lg:order-1 lg:mx-0 lg:max-w-none">
              <LoyaltyPreview />
            ...
            <div className="order-1 max-w-[500px] lg:order-2">
              ...
              <Button href={publicRoutes.product.loyalty} className="mt-8" variant="primary">Explore Loyalty <ArrowRightIcon className="h-4 w-4" /></Button>
            </div>
          </div>
        </Container>
      </section>
