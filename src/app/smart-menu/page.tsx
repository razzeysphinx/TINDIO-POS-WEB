...
export const metadata: Metadata = {
  title:
    "TINDIO Smart Menu | Turn Your Catalog Into a Customer Menu",
  description:
    "Create a customer-facing menu from the products, categories, prices, variants, and options you manage in TINDIO.",
};
...
export default function SmartMenuPage() {
  return (
    ...
    >
      ...
      <section
        id="catalog-menu"
        className="border-y border-stone-200 bg-white py-20 sm:py-28 lg:py-32"
      >
        <Container>
          <div className="grid items-center gap-12 lg:grid-cols-[0.84fr_1.16fr] lg:gap-16 xl:gap-24">
            <CatalogCopy />
      ...
      <section className="bg-[#f5f6f2] py-20 sm:py-28 lg:py-32">
        <Container>
          <div className="grid items-center gap-12 lg:grid-cols-[1.16fr_0.84fr] lg:gap-16 xl:gap-24">
            <div className="order-2 mx-auto w-full max-w-[720px] lg:order-1 lg:mx-0 lg:max-w-none">
              <CategoriesPreview />
            </div>
        ...
        <Container>
          <div className="mx-auto max-w-[780px] text-center">
            ...
            <h2 className="mt-4 text-balance text-4xl font-extrabold tracking-[-0.06em] sm:text-5xl">
              Put your catalog where customers can see it.
            </h2>

            <p className="mx-auto mt-5 max-w-[620px] text-pretty text-lg leading-7 text-emerald-100">
              Explore the TINDIO selling workflow and the catalog that powers
